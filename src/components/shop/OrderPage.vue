            ...
            <div class="col-md-5 col-lg-4 order-md-last">
              ...
              <div class="col-md-7 col-lg-8"><h4 class="mb-3">주문자 정보</h4>
                <div class="needs-validation" novalidate="">
                  <div class="row g-3">
                    <div class="col-12"><label for="cupet_user_name" class="form-label">이름</label>
                      <input type="text" class="form-control" id="cupet_user_name" v-model="state.form.name">
                    </div>
                    <div class="col-12"><label for="cupet_user_address" class="form-label">주소</label>
                      <input type="text" class="form-control" id="cupet_user_address" v-model="state.form.cupet_user_address">
                    </div>
                  </div>
                  <hr class="my-4">
                  ...
                  <div class="my-3">
                    <div class="form-check">
                      <input id="point" name="paymentMethod" type="radio" class="form-check-input" value="point" v-model="state.form.payment">
                      <label class="form-check-label" for="point">포인트 결제</label>
                    </div>
                    <div class="form-check">
                  ...
                  <hr class="my-4">
                  <button class="btn" @click="submit()">결제하기</button>
                </div>
              </div>
            </div>
          </main>
  ...
  export default {
    ...
    setup() {
      ...
      const submit = () => {
        ...
        axios.post("/api1/order", args).then(() => {
          alert('주문 완료');
